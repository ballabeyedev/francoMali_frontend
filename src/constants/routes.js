export const ROUTES = {
  LOGIN:              '/francomaliship/auth/login',
  DASHBOARD:          '/francomaliship/dashboard',
  COLIS:              '/francomaliship/admin/colis',
  COLIS_EN_ATTENTE:   '/francomaliship/admin/colis/en-attente',
  COLIS_LIVRES:       '/francomaliship/admin/colis/livres',
