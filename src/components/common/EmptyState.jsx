...
export default memo(function EmptyState({ message = 'Aucun résultat trouvé', searchTerm }) {
  return (
    <div className="empty-state">
      ...
      <p>{message}</p>
      {searchTerm && (
        <p className="empty-search-term">Aucun résultat pour &ldquo;<strong>{searchTerm}</strong>&rdquo;</p>
      )}
    </div>
  );
});
